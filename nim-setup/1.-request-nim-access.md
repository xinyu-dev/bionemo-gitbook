...
There are 2 ways to use BioNeMo NIMs: 1) free trial where the server is hosted on NVIDIA's resources (aka hosted API). or 2) a downloadable docker container which you can run on your own infrastructure.&#x20;
